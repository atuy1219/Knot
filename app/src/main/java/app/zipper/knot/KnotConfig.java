...
public class KnotConfig {
  ...
  public final Item imageNotificationPreview     = item("image_notification_preview",       "画像メッセージを通知に表示（実験）",        "画像メッセージの通知を即時表示した後、画像を非同期で取得して同じ通知を画像付きに更新します。旧方式の固定待機・ディレクトリ全走査は行いません。", false, Category.NOTIFICATION, "");
