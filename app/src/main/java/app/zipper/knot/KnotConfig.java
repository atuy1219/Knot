...
public class KnotConfig {
  ...
  public final Item imageNotificationPreview     = item("image_notification_preview",       "メッセージ通知を拡張（実験）",              "テキスト通知はLINEの保存直前データまたはDBから本文・送信者・種別を補完し、画像通知はOBSまたはローカルURIからプレビューを取得して同じ通知を更新します。元の通知は待たせません。", false, Category.NOTIFICATION, "");
