...
public class KnotConfig {
  ...
  public final Item imageNotificationPreview     = item("image_notification_preview",       "メッセージ通知を拡張（実験）",              "テキスト通知はLINEの復号直後データまたはDBから本文・送信者・種別を補完し、画像はOBS/ローカルURI、スタンプはLINE Sticker Shop CDNからプレビューを取得して通知に表示します。元の通知は待たせません。", false, Category.NOTIFICATION, "");
