...
final class ThemeElementBridge26110 {
  ...
  static synchronized void install(
    ...
    Class<?> keyClass = Reflect.findClass("m16.g", cl);
    Class<?> valueClass = Reflect.findClass("m16.j", cl);
    Class<?> colorClass = Reflect.findClass("m16.d", cl);
    Class<?> imageClass = Reflect.findClass("m16.f", cl);
    ...
    Method themeResolver =
        Reflect.findMethodExact("o16.d", cl, "b", Map.class, Set.class);
